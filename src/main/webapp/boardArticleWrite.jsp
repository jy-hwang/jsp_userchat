...
%>
  ...
  <body>
    ...
    <div class="container">
      <form method="post" action="./boardArticleWrite" enctype="multipart/form-data">
        <table class="table table-borderd table-hover" style="text-align: center; border: 1px solid #ddd">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input class="form-control" type="text" name="boardTitle" placeholder="글 제목을 입력하세요." maxlength="50" required/></td>
            </tr>
            
            <tr>
              <td style="width: 110px;"><h5>글 내용</h5></td>
              <td><textarea class="form-control" name="boardContent" placeholder="글 내용을 입력하세요." rows="10" maxlength="2048"  required></textarea></td>
            </tr>
