...
%>
  ...
  <body>
          ...
          <li class="dropdown"
            ><a
             ...
             <ul class="dropdown-menu">
              ...
              <li class="active"><a href="updateProfile.jsp">프로필 수정</a></li>
    ...
    <div class="container">
      <form method="post" action="./userUpdateProfile" enctype="multipart/form-data">
        <table class="table table-borderd table-hover" style="text-align: center; border: 1px solid #ddd">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="2">
                <span class="btn btn-default btn-file">이미지를 업로드하세요<input type="file" name="userProfile"></span>
              </td>
            </tr>
             <tr>
